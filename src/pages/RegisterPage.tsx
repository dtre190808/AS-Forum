  ...
  const handleChange = (e: ChangeEvent<HTMLInputElement | HTMLSelectElement>) => {
    ...
    if (name === "gender") {
      ...
      if (value === Gender.MALE) {
        ...
        setErrors((prev) => { const { gender: _, ...rest } = prev; return rest })
      }
      return
    }
    ...
    <div className={styles.page}>
      <div className={styles.card}>
        ...
        <form className={styles.form} onSubmit={handleSubmit} noValidate>
          ...
          <label className={`${styles.checkboxLabel} ${errors.agreeToPolicy ? styles.checkboxError : ""}`}>
            <input
            ...
            <span>
              Я согласен(а) на{" "}
              <a className={styles.policyLink} href="https://100leaders.alabuga.ru/personal-data.pdf" target="_blank" rel="noopener noreferrer">
